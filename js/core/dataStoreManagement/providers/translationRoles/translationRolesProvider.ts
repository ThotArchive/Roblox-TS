...
export const GameLocalizationRolesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1GameLocalizationRolesRolesRoleCurrentUserGet(role: 'translator', exclusiveStartKey?: string, pageSize?: number, groupId?: number, options: any = {}): RequestArgs {
            // verify required parameter 'role' is not null or undefined
            if (role === null || role === undefined) {
...
export const GameLocalizationRolesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1GameLocalizationRolesRolesRoleCurrentUserGet(role: 'translator', exclusiveStartKey?: string, pageSize?: number, groupId?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RobloxTranslationRolesApiGetGameLocalizationRoleAssignmentsForUserResponse> {
            const localVarAxiosArgs = GameLocalizationRolesApiAxiosParamCreator(configuration).v1GameLocalizationRolesRolesRoleCurrentUserGet(role, exclusiveStartKey, pageSize, groupId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const GameLocalizationRolesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1GameLocalizationRolesRolesRoleCurrentUserGet(role: 'translator', exclusiveStartKey?: string, pageSize?: number, groupId?: number, options?: any) {
            return GameLocalizationRolesApiFp(configuration).v1GameLocalizationRolesRolesRoleCurrentUserGet(role, exclusiveStartKey, pageSize, groupId, options)(axios, basePath);
        },
    };
};
...
export interface GameLocalizationRolesApiInterface {
     ...
     * @memberof GameLocalizationRolesApiInterface
     */
    v1GameLocalizationRolesRolesRoleCurrentUserGet(role: 'translator', exclusiveStartKey?: string, pageSize?: number, groupId?: number, options?: any): AxiosPromise<RobloxTranslationRolesApiGetGameLocalizationRoleAssignmentsForUserResponse>;
...
export class GameLocalizationRolesApi extends BaseAPI implements GameLocalizationRolesApiInterface {
     ...
     * @memberof GameLocalizationRolesApi
     */
    public v1GameLocalizationRolesRolesRoleCurrentUserGet(role: 'translator', exclusiveStartKey?: string, pageSize?: number, groupId?: number, options?: any) {
        return GameLocalizationRolesApiFp(this.configuration).v1GameLocalizationRolesRolesRoleCurrentUserGet(role, exclusiveStartKey, pageSize, groupId, options)(this.axios, this.basePath);
    }
