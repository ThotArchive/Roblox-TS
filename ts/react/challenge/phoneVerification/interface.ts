...
/**
 * An error code for the phone verification challenge.
 */
...
/**
 * The parameters required to render a phone verification challenge.
 */
...
/**
 * Renders a phone verification challenge with the given parameters.
 */
