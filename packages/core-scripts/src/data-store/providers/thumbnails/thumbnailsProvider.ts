...
export const AssetsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1AssetsThumbnail3dGet(
        assetId,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
...
export const AvatarApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1UsersAvatarBustGet(
        userIds,
        size,
        format,
        isCircular,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1UsersAvatarGet(
        userIds,
        size,
        format,
        isCircular,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1UsersAvatarHeadshotGet(
        userIds,
        size,
        format,
        isCircular,
...
export const BadgesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1BadgesIconsGet(
        badgeIds,
        size,
        format,
        isCircular,
...
export const BundlesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1BundlesThumbnailsGet(
        bundleIds,
        size,
        format,
        isCircular,
...
export const DeveloperProductsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1DeveloperProductsIconsGet(
        developerProductIds,
        size,
        format,
        isCircular,
...
export const GamesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1GamesMultigetThumbnailsGet(
        universeIds,
        countPerUniverse,
        defaults,
        size,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1GamesUniverseIdThumbnailsGet(
        universeId,
        thumbnailIds,
        size,
        format,
...
export const GroupEmblemApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1GroupsIconsGet(
        groupIds,
        size,
        format,
        isCircular,
...
export const OutfitsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1UsersOutfitsGet(
        userOutfitIds,
        size,
        format,
        isCircular,
...
export const PlacesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1PlacesGameiconsGet(
        placeIds,
        returnPolicy,
        size,
        format,
...
export const PlacesApiFactory = function (
  ...
  return {
    ...
    v1PlacesGameiconsGet(
      ...
      return localVarFp
        .v1PlacesGameiconsGet(placeIds, returnPolicy, size, format, isCircular, options)
        .then(request => request(axios, basePath));
    },
  };
};
