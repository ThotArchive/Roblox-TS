...
export class CursorPager {
  ...
  reloadCurrentPage() {
    ...
    const invalidationIndex = Math.floor(currentIndex / this._loadPageSize) * this._loadPageSize;
  ...
  _setNextPageCursor(nextPageCursor) {
    this._pagingParameters = { ...this._pagingParameters, cursor: nextPageCursor };
  }
