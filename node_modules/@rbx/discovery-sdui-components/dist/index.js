...
const HeroUnitGradient = ({ gradient, gradientHeightPercent, gradientWidthPercent }) => {
    const { startColor, endColor, startOpacity: startTransparency, // opacity is incorrectly named, this is actually transparency
    endOpacity: endTransparency, degree } = gradient;
