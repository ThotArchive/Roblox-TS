...
var CursorPager = /** @class */ (function () {
    ...
    CursorPager.prototype.setNextPageCursor = function (nextPageCursor) {
        this.pagingParameters = __assign(__assign({}, this.pagingParameters), { cursor: nextPageCursor });
    };
    CursorPager.prototype.loadNextPageIntoCache = function (cacheKey, id) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.getItems(__assign(__assign({}, _this.pagingParameters), { count: _this.loadPageSize, pageNumber: loadPageNumber }))
