import { BatchRequestError, DefaultProcessBatchWaitTime } from './batchRequestConstants';
...
var BatchRequestProcessor = /** @class */ (function () {
    ...
    BatchRequestProcessor.prototype.handleBatchResult = function (itemsProcessor, batch, error, properties) {
        ...
        if (minimumCooldown > 0) {
            setTimeout(function () { return _this.processQueue(itemsProcessor, properties); }, minimumCooldown + processBatchWaitTime);
        }
        this.active = false;
    ...
    BatchRequestProcessor.prototype.queueItem = function (itemId, itemProcessor, itemSerializer, properties) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            setTimeout(function () { return _this.processQueue(itemProcessor, properties); }, properties.processBatchWaitTime);
        });
    };
